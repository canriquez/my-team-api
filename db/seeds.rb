...
u1 = FactoryBot.create(:user_user, email: 'email3@gmail.com', name: 'Anna')
u2 = FactoryBot.create(:user_user, email: 'email4@gmail.com', name: 'Clara')
u3 = FactoryBot.create(:user_user, email: 'email5@gmail.com', name: 'Roxana')
u4 = FactoryBot.create(:user_user, email: 'email6@gmail.com', name: 'Caro')
u5 = FactoryBot.create(:user_user, email: 'email7@gmail.com', name: 'Matt')
u6 = FactoryBot.create(:user_user, email: 'email8@gmail.com', name: 'Lautaro')
u7 = FactoryBot.create(:user_user, email: 'email9@gmail.com', name: 'Robert')
