...
RSpec.describe "Likes", type: :request do
     ...
     describe 'POST /likes/' do
        ...
        context 'create like record with :evaluation = dislike with valid credentials and :admin role' do
            let(:valid_post_attributes) {FactoryBot.attributes_for(:like, evaluation: 'dislike', application_id: application1.id, admin_id: admin1.id) }
            it 'creates like' do
                expect do
                    post "/likes", params: valid_post_attributes.to_json, headers: headers_admin1
                end.to change(Like, :count).by(1)
    ...
    describe 'PUT /applications/:id' do
        ...
        let!(:valid_2dislike_a1_01) {FactoryBot.attributes_for(:like, evaluation: 'dislike', application_id: application1.id, admin_id: admin1.id )}
